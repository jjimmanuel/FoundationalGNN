class Masker(torch.utils.data.Dataset):
  ...
  def _apply_masking(self, data):
    ...
    num_nodes_to_mask = int((num_nodes * self.node_mask_prob))
    ...
    num_edges_to_mask = int((num_edges * self.edge_mask_prob))
    ...
    masked_data.edge_attr = data.edge_attr[columns_to_keep, :]
